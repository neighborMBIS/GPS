...
import wj.makedbfile.Buffer.MakeRouteFile;
import wj.makedbfile.Buffer.MakeRouteStationFile;
import wj.makedbfile.Buffer.MakeStationFile;

public class MainActivity extends AppCompatActivity {

    Button receiveR, receiveS, receiveRS;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        receiveR = (Button) findViewById(R.id.receiveRoute);
        receiveS = (Button) findViewById(R.id.receiveStation);
        receiveRS = (Button) findViewById(R.id.receiveRouteStation);
...
//
//                if (Data.readData[BytePosition.HEADER_OPCODE] == OPUtil.OP_ROUTE_DATA_INFO) {
//                    new MakeRouteFile();
//                } else if (Data.readData[BytePosition.HEADER_OPCODE] == OPUtil.OP_STATION_DATA_INFO) {
//                    new MakeStationFile();
//                } else if (Data.readData[BytePosition.HEADER_OPCODE] == OPUtil.OP_ROUTE_STATION_DATA_INFO) {
...
//        });
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.receiveRoute:
                setData(1);
                new Receive_OP(Data.readData[BytePosition.HEADER_OPCODE]);
                new MakeRouteFile();
                break;
            case R.id.receiveStation:
                setData(2);
                new Receive_OP(Data.readData[BytePosition.HEADER_OPCODE]);
                new MakeStationFile();
                break;
            case R.id.receiveRouteStation:
                setData(3);
                new Receive_OP(Data.readData[BytePosition.HEADER_OPCODE]);
                new MakeRouteStationFile();
                break;
        ...
        switch (i) {
            case 1:
                Data.readData
                        //노선정보
                        = new byte[]{
                        0x01, 0x71, 0x03, 0x04, 0x05, 0x06, 0x07, 0x08, 0x09, 0x0a
                        , 0x0b, 0x0c, 0x0d, 0x0e, 0x00, 0x00, 0x00, (byte) 0xE5
                        ...
                        , 0x31, 0x32, 0x33, 0x34, 0x35, 0x36, 0x37, 0x01, 0x30, 0x30
                        //노선유형
                        , 0x01
                        //첫,막차시간
                        , 0x01, (byte) 0xA4
            ...
            case 2:
                ...
                Data.readData
                        ...
                        /****반복****/
                        //지점ID
                        , 0x00, 0x07, 0x39, (byte) 0x8C, (byte) 0xD9
                        //지점 명칭
                        , 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00
                        , 0x00, 0x00, 0x00, (byte) 0xc1, (byte) 0xf6, (byte) 0xc1, (byte) 0xa1, (byte) 0xc1, (byte) 0xf6, (byte) 0xc1
                        , (byte) 0xa1, (byte) 0xc1, (byte) 0xf6, (byte) 0xc1, (byte) 0xa1, (byte) 0xc1, (byte) 0xf6, (byte) 0xc1, (byte) 0xa1, 0x30
                        ...
                        /****반복****/
                        //지점ID
                        , 0x00, 0x0D, (byte) 0xD8, (byte) 0xF8, (byte) 0xA0
                        //지점 명칭
                        , 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00
                        , 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00
                        ...
                        /****반복****/
                        //지점ID
                        , 0x00, 0x21, (byte) 0xB7, (byte) 0x3B, (byte) 0xF5
                        //지점 명칭
                        , 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00
                        , 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00
                        ...
                        /****반복****/
                        //지점ID
                        , 0x00, 0x28, (byte) 0x56, (byte) 0xA7, (byte) 0xBC
                        //지점 명칭
                        , 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00
                        , 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00
                        , 0x00, 0x00, 0x00, 0x00, 0x00, (byte) 0xc1, (byte) 0xf6, (byte) 0xc1, (byte) 0xa1, 0x35
            ...
            case 3:
                Data.readData
                        //RouteStation
                        = new byte[]{
                        0x01, 0x73, 0x03, 0x04, 0x05, 0x06, 0x07, 0x08, 0x09, 0x0a, 0x0b, 0x0c, 0x0d, 0x0e, 0x00, 0x00, 0x00, (byte) 0x86
