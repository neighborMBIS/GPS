...
public class Form_Body_Offence {
    ...
    public void setPassStationId(int passStationId) {
        this.passStationId = Func.integerToByte(passStationId, 10);
    }
    public void setPassStationId(long passStationId) {
        this.passStationId = Func.longToByte(passStationId, 10);
    }
    public void setPassStationId(String passStationId) {
        this.passStationId = Func.integerToByte(Integer.parseInt(passStationId), 10);
    }
    ...
    public void setArriveStationId(int arriveStationId) {
        this.arriveStationId = Func.integerToByte(arriveStationId, 10);
    }
    public void setArriveStationId(long arriveStationId) {
        this.arriveStationId = Func.longToByte(arriveStationId, 10);
    }
    public void setArriveStationId(String arriveStationId) {
        this.arriveStationId = Func.integerToByte(Integer.parseInt(arriveStationId), 10);
    }
    ...
    public void setOffenceCode(int offenceCode) {
        this.offenceCode = Func.integerToByte(offenceCode, 2);
    }
    public void setOffenceCode(String offenceCode) {
        this.offenceCode = Func.integerToByte(Integer.parseInt(offenceCode), 2);
    }
    ...
    public void setReservation(int reservation) {
        this.reservation = Func.integerToByte(reservation, 1);
    }
    public void setReservation(String reservation) {
        this.reservation = Func.integerToByte(Integer.parseInt(reservation), 1);
    }
